    ...
    <BackgroundLayout>
      ...
      <div className=' h-1/2 w-full md:w-2/5 md:h-full'>
        ...
        <div className='md:w-1/2 m-auto p-5 md:p-0'>
          ...
          <p className='font-bold text-3xl text-blackText py-3 md:py-10'>Get Started</p>
          ...
          <div className='lg:w-3/5 m-auto pt-3 md:pt-10'><p className='text-lg font-medium'>By continuing, you confirm you’re  18+ and accepting out <span className='text-blueText font-semibold'> Terms & Conditions</span> and <span className='text-blueText font-semibold'>Privacy Policy</span></p>
        </div>
        </div>
